            ...
            <div className="row d-flex align-items-center mb-4">
                ...
                <div className="col-6 px-4 text-end">
                    <div className="d-flex float-end align-items-center">
                        <p className="m-0 me-4">Bienvenido(a), <span className="fw-bold">{nombre.nombre} {nombre.aPaterno}</span></p>
            ...
            <div className="row">
                <div class="d-flex align-items-start">
                    <div class="nav col-2 flex-column nav-pills me-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <button class="nav-link text-start" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false"><i className="fa-solid fa-gear me-2"></i>Configuración</button>
                    </div>
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabIndex="0">
                            <div className="row text-start" >
                                ...
                                <div className="col-6 border p-3">
                                    <p className='m-0'>Recuento de Citas</p>
                                </div>
                                <div className="col-6 border p-3">
                        ...
                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab" tabIndex="0">
                             <div className="row text-start">
                                <div className="col-12">
                                    <p className="h2 mb-4">Puntos & Ventas</p>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab" tabIndex="0">
                             <div className="row text-start">
                                <div className="col-12">
                                    <p className="h2 mb-4">Configuración</p>
                                </div>
                            </div>
                        </div>
                    </div>
